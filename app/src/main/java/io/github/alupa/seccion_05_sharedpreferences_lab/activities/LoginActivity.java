package io.github.alupa.seccion_05_sharedpreferences_lab.activities;
...
import io.github.alupa.seccion_05_sharedpreferences_lab.R;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void saveOnPreferences(String email, String password){
        if (switchRemember.isChecked()){
            ...
            //editor.commit(); //método para a ser sincrono en vez de asincrono
            editor.apply();
        }
    }
